...
**Date**: 2026-01-26  
**Status**: Draft  
**Purpose**: Define requirements for a truth-synced audit of backend capabilities vs frontend wiring
...
| ID | Requirement | Acceptance Criteria |
|----|-------------|---------------------|
| MAT-1 | Every backend capability must have a matrix row | Each route/handler has exactly one row in `audit/FEATURE_MATRIX.md` |
...
| Status | Definition |
|--------|------------|
| **Wired** | Backend endpoint exists, frontend page/component calls it, navigation reaches it |
