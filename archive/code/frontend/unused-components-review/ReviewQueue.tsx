        ...
        {stats && (
          <div className="p-4 border-b">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                <span>In Review:</span>
                <span className="font-semibold text-blue-600">{stats.in_review}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Approved:</span>
            ...
            <div className="space-y-2">
              {cases.map((c) => (
                <div
                  ...
                  className="bg-white p-4 rounded-lg shadow-sm border hover:border-blue-500 cursor-pointer transition-colors"
                >
