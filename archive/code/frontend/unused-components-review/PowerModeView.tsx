      ...
      <div className="w-1/2 bg-white border-r">
        ...
        <div className="p-4">
          ...
          <div className="bg-gray-100 h-[600px] relative">
            ...
            <div className="absolute top-10 left-10 w-40 h-20 border-2 border-blue-500 bg-blue-100 bg-opacity-30">
              <span className="text-xs bg-blue-500 text-white px-1">Header</span>
            </div>
