/**
 * @deprecated QUARANTINED STORIES - DO NOT INCLUDE IN ACTIVE STORYBOOK
 * 
 * These stories are for the quarantined Navigation component.
 * The Navigation component has been superseded by AppLayout's built-in navigation.
 * 
 * Quarantine Location: frontend/src/legacy_quarantine/components/Navigation.stories.tsx
...
/**
 * @deprecated Navigation Component Stories (QUARANTINED)
 * 
...
- Transitions: \`--duration-1\`
  ...
  decorators: [
    (Story) => {
      ...
      // The actual permissions are provided by PermissionsProvider
