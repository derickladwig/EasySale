/**
 * QUARANTINED: Navigation Configuration
 * 
 * Original Location: frontend/src/common/config/navigation.ts
 * Quarantined: 2026-01-26
 * Reason: Hardcoded nav items - should use tenant config
 * Replacement: config.navigation.main from ConfigProvider
 * 
 * This file is preserved per NO DELETES policy.
 * DO NOT import this file in active code.
 * 
 * Items that were merged into Tenant Config:
 * - Capability requirements (capability field)
 * - Badge key support (badgeKey field)
 * - Dynamic badge fetching logic
 */
