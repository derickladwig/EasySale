  ...
  const cards = [
    {
      ...
      bgColor: 'bg-[var(--color-warning-400)]/10',
      hoverColor: 'hover:bg-[var(--color-warning-400)]/20',
    ...
    },
    {
      ...
      value: stats.failed,
      icon: AlertCircle,
      color: 'text-[var(--color-error-400)]',
      bgColor: 'bg-[var(--color-error-400)]/10',
      hoverColor: 'hover:bg-[var(--color-error-400)]/20',
