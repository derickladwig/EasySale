...
export const BillHistory: React.FC = () => {
  ...
  const handleReprocess = async (billId: string) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Failed to reprocess bill');
    } finally {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Vendor Bill History</h1>
        <button
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-sm space-x-2">
                      ...
                      {bill.status !== 'POSTED' && (
                        <button
                          ...
                          className="text-green-600 dark:text-green-400 hover:text-green-500 dark:hover:text-green-300 disabled:opacity-50"
                        >
      ...
      <div className="mt-6 flex items-center justify-between">
        <div className="text-sm text-gray-700 dark:text-gray-300">Showing {bills.length} bills</div>
