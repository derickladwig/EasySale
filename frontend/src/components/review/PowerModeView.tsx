    ...
    <div className="flex h-screen bg-background-secondary">
      ...
      <div className="w-1/2 flex flex-col overflow-y-auto">
        ...
        <div className="p-4 bg-surface-base border-b border-border">
          ...
          <div className="space-y-2">
            ...
            <div className="bg-background-secondary p-3 rounded">
              ...
              <div className="w-full bg-surface-elevated rounded-full h-2">
                <div className="bg-success-600 h-2 rounded-full w-[70%]"></div>
              </div>
            </div>
        ...
        <div className="p-4 bg-surface-base">
          ...
          <div className="space-y-2">
            <button className="w-full px-4 py-2 bg-surface-overlay text-white rounded hover:bg-surface-elevated">
              Export Debug Data
            </button>
            <button className="w-full px-4 py-2 bg-surface-overlay text-white rounded hover:bg-surface-elevated">
              View Artifact Chain
